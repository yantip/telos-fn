        ...
        >
          ...
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm">
              ...
              <li className="text-slate-800 font-medium">Articles</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
            Expert perspectives on R&D grant strategies, funding opportunities, 
            and deep-tech innovation. Practical knowledge for founders and CTOs.
          </p>
        </motion.div>
      </div>
    </section>
