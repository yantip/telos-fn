        ...
        >
          ...
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm">
              ...
              <li className="text-slate-800 font-medium">Contact</li>
            </ol>
          </nav>
          ...
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed">
            Whether you&apos;re exploring grant options for the first time or looking to 
            optimize your funding strategy, we&apos;re here to help. Reach out for a 
